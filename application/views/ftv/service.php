...
<div class="bg-content"> 
    ...
    <div class="container">
        ...
        <ul class="thumbnails thumbnails-1 list-services">
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img1.jpg" alt="">
              ...
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img2.jpg" alt="">
                  <section> <a href="#" class="link-1">At vero eos et accusamus et iusto </a>
                <p>Deleniti atque corrupti quos dolores molestias excepturi sint occaecati cupiditate nonprovident similique sunt in culpa.</p>
              </section>
                </div>
              ...
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img3.jpg" alt="">
                  <section> <a href="#" class="link-1">At vero eos et accusamus et iusto </a>
                <p>Deleniti atque corrupti quos dolores molestias excepturi sint occaecati cupiditate nonprovident similique sunt in culpa.</p>
              </section>
                </div>
              ...
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img4.jpg" alt="">
                  <section> <a href="#" class="link-1">At vero eos et accusamus et iusto </a>
                <p>Deleniti atque corrupti quos dolores molestias excepturi sint occaecati cupiditate nonprovident similique sunt in culpa.</p>
              </section>
                </div>
              ...
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img5.jpg" alt="">
                  <section> <a href="#" class="link-1">At vero eos et accusamus et iusto </a>
                <p>Deleniti atque corrupti quos dolores molestias excepturi sint occaecati cupiditate nonprovident similique sunt in culpa.</p>
              </section>
                </div>
              ...
              <li class="span4">
            <div class="thumbnail thumbnail-1"> <img  src="<?php echo $base; ?>img/page2-img6.jpg" alt="">
                  <section> <a href="#" class="link-1">At vero eos et accusamus et iusto </a>
                <p>Deleniti atque corrupti quos dolores molestias excepturi sint occaecati cupiditate nonprovident similique sunt in culpa.</p>
              </section>
                </div>

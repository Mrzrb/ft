                        ...
                        <div class="panel-body feed">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        <a href="<?php echo  $base; ?>#">John Doe</a> commented on <a href="#">What Makes Good Code Good</a>.
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        <a href="<?php echo  $base; ?>#">Merge request #42</a> has been approved by <a href="#">Jessica Lori</a>.
                                    </div>
                                    <div class="time pull-left">
                                        10 h
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        New user <a href="<?php echo  $base; ?>#">Greg Wilson</a> registered.
                                    </div>
                                    <div class="time pull-left">
                                        Today
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        Server fail level raises above normal. <a href="<?php echo  $base; ?>#">See logs</a> for details.
                                    </div>
                                    <div class="time pull-left">
                                        Yesterday
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        <a href="<?php echo  $base; ?>#">Database usage report</a> is ready.
                                    </div>
                                    <div class="time pull-left">
                                        Yesterday
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        <a href="<?php echo  $base; ?>#">Order #233985</a> needs additional processing.
                                    </div>
                                    <div class="time pull-left">
                                        Wednesday
                                    </div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text">
                                        <a href="<?php echo  $base; ?>#">Load more...</a>
                                    </div>
                                </div>
                            </section>
                        </div>
                ...
                <div class="col-lg-4">
                    <header>
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="<?php echo  $base; ?>#stats">Users</a>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="<?php echo  $base; ?>#report">Favorites</a>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="<?php echo  $base; ?>#dropdown1">Commenters</a>
                            </li>
                        </ul>
                    </header>
                            ...
                            <ul class="news-list">
                                <li>
                                    ...
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Ivan Gorge</a></div>
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Roman Novak</a></div>
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Teras Uotul</a></div>
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Deral Ferad</a></div>
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Konrad Polerd</a></div>
                        ...
                        <div class="tab-pane" id="report">
                            ...
                            <ul class="news-list news-list-no-hover">
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Pol Johnsson</a></div>
                                        <div class="options">
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Terry Garel</a></div>
                                        <div class="options">
                                            <button class="btn btn-xs btn-success">
                                                <i class="fa fa-phone"></i>
                                                Call
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Eruos Forkal</a></div>
                                        <div class="options">
                                            <button class="btn btn-xs btn-success">
                                                <i class="fa fa-phone"></i>
                                                Call
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Remus Reier</a></div>
                                        <div class="options">
                                            <button class="btn btn-xs btn-success">
                                                <i class="fa fa-phone"></i>
                                                Call
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Lover Lund</a></div>
                                        <div class="options">
                                            <button class="btn btn-xs btn-success">
                                                <i class="fa fa-phone"></i>
                                                Call
                        ...
                        <div class="tab-pane" id="dropdown1">
                            ...
                            <ul class="news-list">
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Edin Garey</a></div>
                                        <div class="comment">
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Firel Lund</a></div>
                                        <div class="comment">
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Jessica Desingter</a></div>
                                        <div class="comment">
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Novel Forel</a></div>
                                        <div class="comment">
                                ...
                                <li>
                                    <i class="fa fa-user fa-4x pull-left"></i>
                                    <div class="news-item-info">
                                        <div class="name"><a href="<?php echo  $base; ?>#">Wedol Reier</a></div>
                                        <div class="comment">
